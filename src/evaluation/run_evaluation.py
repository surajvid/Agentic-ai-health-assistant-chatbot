...
def main():
    ...
    evaluator = Evaluator(patient_df=final_df)

    detailed_results = evaluator.evaluate_all(EVALUATION_TEST_CASES)
    summary = evaluator.summarize_results(detailed_results)
    report = evaluator.build_report(summary, detailed_results)
